...
namespace AsuTest.Controllers
{
    public class BooksController : Controller
    {
        ...
        public BooksController(UseContext context)
        {
            _context = context;
        }
        ...
        {
            //ViewBag.LBook = new SelectList(_context.Books, "Id", "Status");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Author,Description,Status")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Author,Description,Status")] Book book)
        {
            if (id != book.Id)
            {
                return NotFound();
